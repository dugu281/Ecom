...
function ProductScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(`https://ecom-server.vercel.app/products/slug/${slug}`);
  ...
  const addToCartHandler = async () => {
    ...
    const { data } = await axios.get(`https://ecom-server.vercel.app/products/${product._id}`);
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `https://ecom-server.vercel.app/products/${product._id}/reviews`,
      ...
      <div className='row w-100'>
        ...
        <div className="col-12 col-md-6" md={3}>
          <ul className='list-unstyled '>
            ...
            {/* <li className='my-3'>
              <div className='row g-2 row-cols-md-4 row-cols-xs-1'>
        ...
        {/* <div className="col-12 col-md-" md={3}> */}
        {/* <Card>
            <Card.Body>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <div className='row'>
                    ...
                    <div className="col-12 col-md-">${product.price}</div>
                  </div>
                </ListGroup.Item>
                <ListGroup.Item>
                  <div className='row'>
                    <div className="col-12 col-md-">Status:</div>
